...
describe('CheckoutOrderService', () => {
  ...
  const checkout = (): CheckoutResponse => ({ order_id: 123 } as unknown as CheckoutResponse);
  ...
  it('processes order and payment', async () => {
    ...
    const body: OrderRequest = { payment_method: 'cod', billing_address: { first_name: 'John', last_name: 'Doe', address_1: '123 Main St', city: 'Athens', postcode: '12345', country: 'GR', email: 'john@example.com' } } as OrderRequest;
  ...
  it('handles error', async () => {
    ...
    const body: OrderRequest = { payment_method: 'cod', billing_address: { first_name: 'A', last_name: 'B', address_1: '1', city: '', postcode: '', country: '', email: '' } } as OrderRequest;
