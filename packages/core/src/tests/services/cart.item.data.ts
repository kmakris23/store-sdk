export const cartItemData = [
    ...
    images: [
      {
        ...
        thumbnail:
          'https://store.local/wp-content/uploads/2023/01/beanie-2-450x450.jpg',
        srcset:
  ...
  },
  {
    ...
    permalink:
      'https://store.local/product/hoodie/?attribute_pa_color=red&attribute_logo=No',
    images: [
      {
        id: 40,
        src: 'https://store.local/wp-content/uploads/2023/01/hoodie-2.jpg',
        thumbnail:
          'https://store.local/wp-content/uploads/2023/01/hoodie-2-450x450.jpg',
        srcset:
